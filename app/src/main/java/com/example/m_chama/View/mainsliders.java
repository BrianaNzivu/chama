...
import com.example.m_chama.Model.Intromanager;
import com.example.m_chama.R;

public class mainsliders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
...

        {
            ...
            Intent i = new Intent(mainsliders.this, Register.class);
            startActivity(i);
            finish();
        }
        ...
        setContentView(R.layout.activity_mainsliders);
